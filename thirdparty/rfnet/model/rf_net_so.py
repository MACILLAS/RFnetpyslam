...
class RFNetSO(RFNetModule):
    ...
    def inference(self, im_data, im_info, im_raw):
        im_rawsc, im_scale, im_orint = self.det(im_data.contiguous())
    ...
    def detectAndComputeNoLoad(self, im, device, output_size):
        """
        it works exactly like detectAndCompute except...
        instead taking the im_path and loading the img...
        it takes the img.
