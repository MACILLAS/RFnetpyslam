...
class FeatureDetectorTypes(Enum):
    ...
    RFNET = 25  # [end-to-end] joint detector-descriptor - "RF-Net image matching network based on receptive fields"
...
class FeatureDescriptorTypes(Enum):
    ...
    RFNET = 30  # [end-to-end] joint detector-descriptor  - "RFNet: image matching network based on receptive fields"
...
class FeatureInfo(object):
    ...
    max_descriptor_distance[
        FeatureDescriptorTypes.FREAK] = 180  # FREAK
    #
    ...
    max_descriptor_distance[FeatureDescriptorTypes.RFNET] = 5  # RFNET, idk if this threshold is correct...
    #
